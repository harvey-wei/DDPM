...
def main():
    ...
    parser.add_argument("--max_num_img_per_class", type=int, default=2000)
    parser.add_argument("--num_model_training_steps", type=int, default=100000)
    parser.add_argument("--num_diffusion_timesteps", type=int, default=10000)
